...
* `endpoint` (optional, default = `private`): The resource key endpoint visibility. Supported values are `public`, `private`, and `public-and-private`. [Learn more](https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/resource_key#argument-reference).
